                    ...
                    echo'<div class="panel">
                        ...
                        <div class="panel-body">
                            <table id="demo-dt-basic" class="table table-striped table-bordered" cellspacing="0" width="100%">
                                ...
                                <tbody>';
                                $stf=$_COOKIE['staff_ur'];

                                $qra="SELECT `user_id`, `rollno`, `fname`, `lname`, `email`, `phone`, `password`, `address`, `programme`, `course`, `section`, `class_advisor`, `created_at` FROM `users` WHERE `class_advisor`='$stf'";
