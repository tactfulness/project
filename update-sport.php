					...
					<div class="row">
					    <div class="col-lg-6 col-lg-offset-3">
					        ...
					        <div class="panel-heading">
					            <h3 class="panel-title">Update Your Sports Details</h3>
					        </div>
					        <div class="panel-body">
                                <form action="upload_pro.php" method="post" enctype="multipart/form-data">
									...
									<div class="form-inline-lg">
                                        <input type="text" class="form-control"  placeholder="Sport name" name="sport_name" id="pro_title">
                                    </div><br>                                    
                                   
                                    <div class="form-inline-lg">
                                        <input type="text" class="form-control"  placeholder="College Name" name="clg_name" id="cl_name">
                                    </div><br>
									<div class="form-inline-lg">
                                        <input type="text" class="form-control"  placeholder="College Place" name="clg_place" id="cl_place">
                                    </div><br>
									<div class="form-inline-lg">
                                    ...
                                    <div class="form-inline-lg">
                                        <input type="date" class="form-control"  placeholder="Participated Date" name="p_date" id="p_date">
                                    </div><br>
                                     <div class="form-inline-lg">
