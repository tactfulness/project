		...
		<div class="cls-content">
		    ...
		    <div class="cls-content-sm panel">
		        <div class="panel-body">
					            	...
					            	<?php
											...
											$query = "SELECT * FROM `users` WHERE `rollno`='$username' AND `password`='$password'";
										        ...
										        if($rows==1){
													...
													setcookie("rollno", $_SESSION['rollno'], time()+300); 
													setcookie("user_id", $we, time()+300); 
					                ...
					                <div class="tab-content">
					                    <div id="demo-tabs-box-1" class="tab-pane fade in active">
											<form action="" method="post">
												<div class="form-group">
													<input type="text" class="form-control" placeholder="Rollno" name="rollno" autofocus>
												</div>
												<div class="form-group">
													<input type="password" class="form-control" placeholder="Password" name="pasasword">
												</div>
					                    ...
					                    <div id="demo-tabs-box-2" class="tab-pane fade">
											...
											<form action="staff-log.php" method="post" enctype="multipart/form-data">
												<div class="form-group">
													<input type="text" class="form-control" placeholder="Username" name="st_ur" autofocus>
												</div>
												<div class="form-group">
													<input type="password" class="form-control" name="s_pass" placeholder="Password">
												</div>
					...
					<!--	
		            <form action="http://www.themeon.net/nifty/v2.6.1/index.html">
		                <div class="form-group">
