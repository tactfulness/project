...
--
-- Host: localhost
-- Generation Time: Oct 21, 2017 at 02:22 PM
...
--
-- Table structure for table `industrial_visits`
--
...
CREATE TABLE `industrial_visits` (
  ...
  `company_place` varchar(80) NOT NULL,
...
INSERT INTO `paper_presentations` (`pp_id`, `pp_title`, `clg_type`, `clg_name`, `clg_place`, `certificate_path`, `ppr_prize`, `p_date`, `created_at`, `user_id`) VALUES
(1, 'network', '', 'gct', 'cbe', '', '2', '2017-10-03', '2017-10-02', 1);
...
CREATE TABLE `project_presentations` (
  ...
  `college type` varchar(50) NOT NULL,
...
--
-- Indexes for table `industrial_visits`
--
ALTER TABLE `industrial_visits`
...
--
-- AUTO_INCREMENT for table `industrial_visits`
--
ALTER TABLE `industrial_visits`
